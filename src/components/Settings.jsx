...
const Menu = () => {
    ...
    return (
        <div className="min-h-screen w-full md:max-w-md bg-gray-50 dark:bg-gray-950 py-8 px-4 sm:px-6 select-none">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-800 rounded-3xl overflow-hidden space-y-3">
                    ...
                    <div className="p-2 bg-white dark:bg-gray-900 border-b border-gray-300 dark:border-gray-800">
                        <div className="flex items-center justify-between">
                            ...
                            <NavLink to="/profile">
                                <button className="p-2.5 bg-gray-950 hover:bg-gray-900 dark:bg-white dark:hover:bg-gray-200 text-xs font-medium leading-tight text-white rounded-md dark:text-gray-900 whitespace-nowrap">
                                    See Profile
                                </button>
                            </NavLink>
                        </div>
                    ...
                    <div className="p-2 opacity-40 pointer-events-none hover:bg-gray-100 dark:hover:bg-gray-800/50 rounded-lg">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <h3 className="text-lg font-medium text-gray-950 dark:text-gray-200">Notifications</h3>
                                </div>
                            </div>
                    ...
                    <div className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <h3 className="text-lg font-medium text-gray-950 dark:text-gray-200">
                                        Switch theme
                                    </h3>
                                </div>
                            </div>
                        ...
                        <a href="mailto:dope.mukeshyadav@gmail.com" className="p-2 block hover:bg-gray-100 dark:hover:bg-gray-800/50 rounded-lg">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-3">
                                        <h3 className="text-lg font-medium text-gray-950 dark:text-gray-200">Help & Support</h3>
                                    </div>
                                </div>
                            </div>
                        </a>
