...
const Header = ({ isAuthenticated, setIsAuthenticated }) => {
  ...
  return (
    <header className='flex items-center justify-center sticky top-0 z-50 bg-white dark:bg-zinc-900'>
      {/* ----- logo ----- */}
      <div className='flex flex-grow max-w-[1024px] flex-1 lg:border lg:dark:border-zinc-700 py-4 px-4 justify-between items-center bg-zinc-50 dark:bg-zinc-800/50 lg:rounded-xl'>
        <NavLink to='/' className='flex items-center gap-2'>
          <img src={logo} alt="" className='w-8 rounded-md rotate-center-alternate' />
          <h1 className='text-lg text-zinc-800 dark:text-white font-bold text-focus-in-normal'>Ormat</h1>
        </NavLink>
        ...
        <div className='flex items-center gap-2'>
          ...
          <NavLink to='/histry' className='flex items-center'>
            {/* <img src={historyIcon} alt="" className="w-8 p-1 bg-zinc-100 dark:bg-zinc-900 border dark:border-zinc-700 rounded-md active:bg-zinc-200 dark:active:bg-zinc-700" /> */}
          
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 p-1.5 bg-zinc-100 dark:bg-zinc-900 border dark:border-zinc-700 rounded-lg active:bg-zinc-200 dark:active:bg-zinc-700" stroke='currentColor'>
          ...
          <NavLink to="/settings" className='flex items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 p-1.5 bg-zinc-100 dark:bg-zinc-900 border dark:border-zinc-700 rounded-lg active:bg-zinc-200 dark:active:bg-zinc-700">
